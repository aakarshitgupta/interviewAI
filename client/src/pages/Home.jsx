          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`border-green-100 relative bg-white rounded-3xl border-2 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
          ...
          <div className='mb-32'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, ý: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
