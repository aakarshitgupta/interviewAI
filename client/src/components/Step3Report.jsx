        ...
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          ...
          <div>
            ...
            <p className='text-gray-500 mt-2'>
              AI powered insights to enhance your interview performance.
            </p>
          </div>
        </div>
        <button onClick={downloadPDF} className='bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>Download Report</button>
      </div>
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 1g:gap-8'>
          ...
          <motion.div
            ...
            <div className='space-y-6'>
              {questionWiseScore.map((q, i) => (
                <div key={i} className=' sm:rounded-2xl border bg-gray-50 p-4 sm:p-6 rounded-xl border-gray-200'>
