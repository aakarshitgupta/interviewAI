            ...
            [
                {
                    ...
                    Return only raw JSON. Do not use markdown, code fences, or explanation.
                    {
                        "role": "string",
                        "experience": "string",
...
export const submitAnswer = async (req, res) => {
    try {
        ...
        if (timeTaken > question.timeLimit) {
            question.score = 0;
            question.feedback = "Time limit exceeded, you did not answer in time.";
...
export const finishInterview = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            message: "Error finishing interview.",
            error: error
        });
    }
}
